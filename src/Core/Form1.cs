...
namespace Subachup
{
	...
	public class Form1 : System.Windows.Forms.Form
    {
		...
		private void InitializeComponent()
		{
            ...
            this.mnuChooseFolder.Text = "&Choose Folder...";
            this.mnuChooseFolder.Click += new System.EventHandler(this.mnuChooseFolder_Click);
            // 
            // menuISave
            // 
            ...
            this._modeControl.Size = new System.Drawing.Size(779, 507);
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
			...
			{
				UseFolder(LastUsedPlayListPath, false);
			}
		...
		private void UseFolder(string directory,bool doRemember)
		{
			if(doRemember)
			...
			UtteranceCollection.CurrentUtteranceSet.LoadFromDirectory(directory, true);

			mruHandler1.AddRecentlyUsedFile(directory);
			UpdateWindowCaption();
		...
		{
			this.Text = Application.ProductName + "   " + PreviousDirectory;
		}
		...
		{
			if(!Directory.Exists(e.File))
			{
				//TODO: add this ability mruHandler1.RemoveFile(e.File);
			}
			else
				UseFolder(e.File, true);		
		}


		private void mnuChooseFolder_Click(object sender, System.EventArgs e)
		{

			//try to start at the parent of the current quiz folder
			if(PreviousDirectory != null && Directory.Exists(PreviousDirectory))
			{
				this.folderBrowserDialog1.SelectedPath = Directory.GetParent(PreviousDirectory).FullName ;
			}
			else
				this.folderBrowserDialog1.SelectedPath = "C:\\";
			...
			UseFolder( folderBrowserDialog1.SelectedPath, true);	
		}
		...
		{
			UtteranceCollection.CurrentUtteranceSet.SavePlayList(PreviousDirectory);
		}
		...
		private void mnuSaveAs_Click(object sender, System.EventArgs e)
		{
			...
			PreviousDirectory = folderBrowserDialog1.SelectedPath;
