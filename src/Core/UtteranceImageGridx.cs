...
namespace Subachup
{
    ...
    public partial class UtteranceImageGridx : UserControl
    {
...
//                ReplaceImage(item, image);
        ...
        private void InitializeComponent()
        {
            ...
            this.Load += new System.EventHandler(this.UtteranceImageGrid_Load);
            this.ResumeLayout(false);

        }

        private void UtteranceImageGrid_Load(object sender, EventArgs e)
        {
